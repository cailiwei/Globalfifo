...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	/* DSI Bit Clock at 420 MHz, 4 lane, RGB888 */
    /* regulator */
	{0x03, 0x01, 0x01, 0x00},
	/* timing */
...
static int mipi_video_sharp_720p_pt_init(void)
{
	int ret;
	...
	pinfo.wait_cycle = 0;
	pinfo.bpp = 24;
	pinfo.lcdc.h_back_porch = 16;//257;
	pinfo.lcdc.h_front_porch = 96;//14;
	pinfo.lcdc.h_pulse_width = 16;//7;
	pinfo.lcdc.v_back_porch = 4;
	pinfo.lcdc.v_front_porch = 5;//2;
	...
	pinfo.clk_rate = 350000000;//450000000;
	pinfo.bl_max = 255;
	pinfo.bl_min = 1;
	pinfo.fb_num = 2;
	...
	pinfo.mipi.hfp_power_stop = FALSE;//TRUE; /* LP-11 during the HFP period */
	pinfo.mipi.hbp_power_stop = FALSE;//TRUE; /* LP-11 during the HBP period */
	pinfo.mipi.hsa_power_stop = FALSE;//TRUE; /* LP-11 during the HSA period */
